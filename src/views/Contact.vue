    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-xl-6">
          <h1 class="section__title section__title--head">Kontak</h1>
        </div>

        <div class="col-12 col-xl-6">
          <ul class="breadcrumb">
            <li class="breadcrumb__item"><a href="index.html">Home</a></li>
            <li class="breadcrumb__item breadcrumb__item--active">Kontak</li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-12 col-lg-7 col-xl-8">
          <form class="sign__form sign__form--contacts">
            <div class="row">
              ...
              <div class="col-12 col-xl-6">
                <div class="sign__group">
                  <input type="text" name="email_address" class="sign__input" placeholder="Email" />
                  <!-- @error('email_address')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
        ...
        <div class="col-12 col-lg-5 col-xl-4">
          ...
          <p class="section__text">
            It is a long fact that a reader will be distracted by the readable content of
            a page when looking at its layout
          </p>
          <ul class="contacts__list">
            <li>
              <a href="tel:+62822-6999-0089">+62822-6999-0089</a>
            </li>
            <li>
              <a href="mailto:riskirahmand0@gmail.com">riskirahmand0@gmail.com</a>
            </li>
          </ul>
