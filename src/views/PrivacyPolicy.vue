  ...
  <section class="section section--pb0 section--gradient">
    <div class="container">
      <div class="row">
        <!-- section text -->
        <div class="col-12">
          <p class="section__text section__text--small">It is a long established fact that a reader will be distracted
          ...
          <p class="section__text section__text--small">Many desktop publishing packages and <a href="#">web page</a>
          ...
          <p class="section__text section__text--small">All the Lorem Ipsum generators on the <b>Internet</b> tend to
        ...
        <!-- section text -->
        <div class="col-12">
          <p class="section__text section__text--small">All the Lorem Ipsum generators on the Internet tend to repeat
